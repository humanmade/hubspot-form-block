...
window.addEventListener('hs-form-event:on-ready', event => {
  ...
  const submitButton = document.querySelector(`#${instanceId} [type="submit"]`);
  ...
  if (config.inlineMessage) {
    ...
    const policy = window.trustedTypes.createPolicy('purifiedHTML', {
      createHTML: input => dompurify__WEBPACK_IMPORTED_MODULE_0__["default"].sanitize(input)
    });
